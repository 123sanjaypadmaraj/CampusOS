...
-- Seed demo user profile (matches App.js defaultLoginId)
...
cross join (
  values
    ...
    ('Tango','Rolls Â· Noodles Â· Biryani Â· Pasta','Moderate',12,18,'moderate',58,'moderate'),
    ('Munch','Fried Rice Â· Noodles Â· Chinese','Busy',20,28,'busy',84,'busy'),
    ('Nescafe','Coffee Â· Maggi Â· Snacks','Quiet',6,10,'quiet',26,'green')
