...
jest.mock("./services/mvpService", () => ({
  ...
  getMyPendingPaymentEvents: jest.fn(() => Promise.resolve([])),
  startEventRegistrationPayment: jest.fn(() => Promise.resolve({ key_id: "rzp_test", gateway_order_id: "order_x", amount: 10000, currency: "INR", payment_id: "pay-1" })),
  startEventRegistrationRefund: jest.fn(() => Promise.resolve({ ok: true })),
  getSavedEvents: jest.fn(() => Promise.resolve([])),
  toggleSavedEvent: jest.fn(() => Promise.resolve(null)),
  getSavedPosts: jest.fn(() => Promise.resolve([])),
  toggleSavedPost: jest.fn(() => Promise.resolve(null)),
  uploadPostImage: jest.fn(() => Promise.resolve("https://cdn/post-media/x.jpg")),
  submitSuspensionAppeal: jest.fn(() => Promise.resolve(null)),
  getMySuspensionAppeal: jest.fn(() => Promise.resolve(null)),
